...
The reason is that my PC GPU is currently broken, which prevents me from properly working on, testing, and continuing development of the project. Because of this hardware issue, progress from my side will be temporarily stopped until the problem is fixed.
